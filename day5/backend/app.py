...
from routes.category import CategorySpecific, CategoryResource
api.add_resource(CategoryResource, '/category')
api.add_resource(CategorySpecific, '/category/<int:id>')

from routes.celery_routes import CeleryResource, CeleryAddResource, CeleryQueryResource, CeleryEmailResource
api.add_resource(CeleryEmailResource, '/celery/email')
api.add_resource(CeleryQueryResource, '/celery/query/<int:a>')
api.add_resource(CeleryAddResource, '/celery/add/<int:x>/<int:y>')
api.add_resource(CeleryResource, '/celery')
